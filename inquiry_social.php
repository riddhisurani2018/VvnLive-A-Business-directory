            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="page_title">
                        <h2>Inquiry: Social Marketing</h2>
                    </div>
                    <nav id="breadcrumbs">
                        <ul>
                            <li><a href="index.php">Home</a>/</li>
                            <li>Inquiry: Social Marketing</li>
                        </ul>
                    </nav>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row sub_content">
            <div class="col-lg-6 col-sm-6" style="margin-left: 25%; margin-right: 25%">
                ...
                <form id="inquireform" action="inquiryverify.php?form=inquiry_social" method="post" name="inquireform" action="">
