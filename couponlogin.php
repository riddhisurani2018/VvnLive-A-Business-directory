        ...
        <div class="row sub_content">
            <div class="col-lg-6 col-sm-6">
                ...
                <input id="lname" type="text" name="lname" autocomplete="off" class="form-control" onkeyup="capitalise4()" placeholder="Last name" required> 
                    ...
                    <div class="form-group">
                <input id="cno" type="text" name="cno" autocomplete="off" class="form-control" maxlength="10" onkeyup="ValidateNo(event)"  placeholder="Number" required> 
				<span  id="cerr" class="dsNone error red-text"></span>
				</div>
			  
			  
                    <div class="form-group">
                <input id="email" type="email" name="email"  placeholder="Email" autocomplete="off" class="form-control" onkeyup="ValidateEmail()" required> 
				<span  id="emailerr" class="dsNone error red-text"></span>
              </div>
			<div id='username_availability_result4' class="green-text ">
          </div> 
          		
                    <div class="form-group">
                <input id="password2" type="password" name="password2" autocomplete="off" onkeyup="ValidatePass()" class="form-control" placeholder="Password" required> 
				<span  id="passerr" class="dsNone error red-text"></span>
			  </div>
            ...
            <div class="col-lg-5 col-sm-5 col-lg-offset-1">
                ...
                <form id="loginform" action="<?php //if(($bid=$_GET['businessid'])!==null)
						//{
							//echo "loginverify.php?businessid=$bid";
						//}
						//else
						//{
							echo "loginverify.php";
						//}
				?>" method="post" name="loginform" action="">
