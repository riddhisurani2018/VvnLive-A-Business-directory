            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="page_title">
                        <h2>Inquiry: Online Ads</h2>
                    </div>
                    <nav id="breadcrumbs">
                        <ul>
                            <li><a href="index.php">Home</a>/</li>
                            <li>Inquiry: Online Ads</li>
                        </ul>
                    </nav>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row sub_content">
            <div class="col-lg-6 col-sm-6" style="margin-left: 25%; margin-right: 25%">
                ...
                <form id="inquireform" action="inquiryverify.php?form=inquiry_online_ads" method="post" name="inquireform" action="">
			...
			<div id='username_availability_result4' class="green-text ">
				...
				<option>Large Skyscraper</option>
				<option>Large Mobile Banner</option>
				<option>Large Rectangle</option>
				</select>	
				</div>
